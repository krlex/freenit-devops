...
echo "$BIN_DIR/download_repos.sh" > /home/vagrant/start.sh > /dev/null 2>&1
echo "$BIN_DIR/devel.sh" >> /home/vagrant/start.sh > /dev/null 2>&1
chmod +x /home/vagrant/start.sh > /dev/null 2>&1
